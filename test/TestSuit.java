...
import ca.concordia.risk.controllerTest.TournamentControllerTest;
...
@RunWith(Suite.class)
@SuiteClasses({MainClassTest.class, MapOperationsTest.class, MapValidateTest.class, MapWriterTest.class, PlayerAttackPhaseTest.class, PlayerReinforcementTest.class, playerFortifyTest.class, DiceTest.class, TournamentControllerTest.class})
